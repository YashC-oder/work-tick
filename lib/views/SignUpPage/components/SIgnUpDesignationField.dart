...
class SignUpDesignationField extends ConsumerWidget {
  const SignUpDesignationField({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FormField<String>(
      initialValue: controller.designation,
      validator: (value) {
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    ref.read(signUpControllerProvider).setDesignation(newValue!);
                    state.didChange(newValue); // Update FormField state
                  },
                  items: SignUpModel.designations.map<DropdownMenuItem<String>>((String value) {
